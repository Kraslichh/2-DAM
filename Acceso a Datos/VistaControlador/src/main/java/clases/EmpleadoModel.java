...
public class EmpleadoModel {
    ...
    public List<Empleados> getAllEmpleados() throws SQLException {
        List<Empleados> empleados = new ArrayList<>(); // Inicializa una lista para almacenar los clientes
        PreparedStatement stmt = conn.prepareStatement("SELECT * FROM empleados"); // Crea una declaración SQL
        ...
        while (rs.next()) {
            ...
            empleados.add(new Empleados(id, nombre, apellido, dni)); // Agrega cada Cliente a la lista
        }
